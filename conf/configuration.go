...
type configOptions struct {
	...
	Sonos                           sonosOptions        `json:",omitzero"`
...
func setViperDefaults() {
	...
	viper.SetDefault("sonos.enabled", false)
	viper.SetDefault("sonos.servicename", "Navidrome")
	viper.SetDefault("sonos.autoregister", false)
